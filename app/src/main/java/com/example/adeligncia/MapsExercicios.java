...
public class MapsExercicios extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_exercicios);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(CaxiasDoSul).title("Marker in Caxias Do Sul"));
        ...
        mMap.addMarker(new MarkerOptions().position(Centro).title("Marker in Centro").icon(
